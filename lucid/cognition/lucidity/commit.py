...
from lucid.cognition.lucidity.config import normalize_task_intent
...
def _frame_render_unit(
    *,
    ...
    member_surfaces = [surfaces[ref] for ref in frame.member_evidence_refs if ref in surfaces]
    return RenderUnit(
